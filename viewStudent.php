<?php 
  ...
  if(!$connect->query($sql)){
    die($connect->error); //prints message and exits
  }
...
<body>
    ...
    <!-- defines set of navigation links -->
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
         ...
         <!-- defines a division or a section in document --> 
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <form method='get' action='search.php' class="form-inline my-2 my-lg-0 ml-auto">
              <!-- input field where the user can enter the data -->
    ...
    <div class="container">
        ...
        <div class="card-body">
        <!-- adds card title to any heading element -->
